...
def depthFirstSearch(problem):
  ...
  """
    ...
    Exemplo: ((x,y), string) sendo string a direcao que o pacman ta tomando"""
...
def breadthFirstSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    """A diferenca estah apenas na implementacao do util.Queue, que empilha as direcoes, tornando a precedencia
    de direcao diferente, no caso, cima, baixo, direita, esquerda. O resto da funcao funciona
...
def uniformCostSearch(problem):
    ...
    essa funcao dah pop no item de menor custo que estiver na fila"""
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    funcao PriorityQueue, sao as coordenadas que possuem o menor custo ateh o momento
    do pacman
    """
