...
def aStarSearch(problem, heuristic=nullHeuristic):
  ...
  "*** YOUR CODE HERE ***"
  """Funciona quase como o custo uniforme, mas quando o custo comeca a ficar muito grande
  acontece que o pacman para de seguir por aquele caminho
  O custo fica muito grande pq soma o custo uniforme com o custo heuristico
  quando o custo fica muito grande, eh como um limite para o pacman
  Ele simplesmente para de ir por aquele caminho e volta os passos necessarios
